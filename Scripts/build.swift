...
print("Raw task: \(rawTask) \(rawPlatforms.joined(separator: " "))")
...
for rawPlatform in rawPlatforms {
    ...
    print("Launching command 1: /usr/bin/xcodebuild \(xcodeBuildArguments.joined(separator: " "))")
