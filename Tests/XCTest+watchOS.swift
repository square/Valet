...
func measure(function: String = #function, block: () -> Void) {
    ...
    let averageExecutionTime = totalTime / CFAbsoluteTime(timesToExecuteBlock)
    
    print("Test Case '\(function)' measured [Time, seconds] average: \(averageExecutionTime), values: \(measuredTime), performanceMetricID:com.apple.XCTPerformanceMetric_WallClockTime")
}
#endif
